...
class CitySegmentation(data.Dataset):
    ...
    def __init__(self, root='/workspace/ShareData/Data/cityscapes', split='train', mode=None, transform=None, base_size=520, crop_size=480, **kwargs):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            w = 1024
            img = img.resize((w,int(w/2)), Image.BILINEAR)
